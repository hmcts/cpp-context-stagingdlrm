...
*Added 2026-09-04, at the DD-43192/DD-43194 restart. Supersedes this ADR's original BC-11
characterization wherever it appears above (the Bucket A tables' BC-11 rows, and decision 3's scope
list) — this decision is the amendment instrument and wins where the two disagree, exactly as decision 7
established for its own corrections.*
