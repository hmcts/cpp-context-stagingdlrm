...
> Mechanics are fixed by [ADR-006](../adrs/006-j25-branch-milestone-and-funcapp-jdk.md); this document
...
| Depends on | **[DD-43192 parity stage](../DD-43191-DD-43192-j25-parity/00-input-brief.md) merged to `team/25.104.x`** — hard, see FR1. Plus [ADR-006](../adrs/006-j25-branch-milestone-and-funcapp-jdk.md) accepted, including its open decision 6 |
...
milestones stale and must not be copied (ADR-006 decision 2).
...
- **FR15 — `stagingdlrm-azure-functions` moves to Java 25.** Verified supportable: Azure Functions
  ...
  enumerated in [ADR-006](../adrs/006-j25-branch-milestone-and-funcapp-jdk.md) decision 4:
...
- **FR17 — BC-12's fleet fix must not be applied to the Function App.** Its four compile-scope
  ...
  sweep does not "correct" it (ADR-006 decision 5).
...
- **FR20 — Resolve the `anonymise` module decision.** ADR-006 decision 6 is **open**:
