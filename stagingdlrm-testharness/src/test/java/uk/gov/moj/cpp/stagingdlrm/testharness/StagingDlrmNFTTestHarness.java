...
public class StagingDlrmNFTTestHarness {

    public static void main(String[] args) throws IOException, URISyntaxException {

        final String config = "config-nft.properties";

        try (final InputStream input = StagingDlrmNFTTestHarness.class.getClassLoader().getResourceAsStream(config);
