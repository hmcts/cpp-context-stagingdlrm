 ...
 * {@code stagingdlrm-command-handler/pom.xml}). {@code javax.json:javax.json-api:1.0} also reaches
 * this module's compile classpath, transitively via {@code id-mapper-client} &rarr;
